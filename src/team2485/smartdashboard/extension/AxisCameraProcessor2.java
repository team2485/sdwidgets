...
public class AxisCameraProcessor2 extends StaticWidget {
    ...
    private final HashMap<String, AxisCameraConfig> configs = new HashMap<>();
    ...
    public AxisCameraProcessor2() {
        ...
        try {
            ...
            for (String prop : props.stringPropertyNames()) {
                configs.put(prop, AxisCameraConfig.parse(props.getProperty(prop)));
            }
    ...
    public void init() {
        ...
        try {
            noneImage  = ImageIO.read(AxisCameraProcessor2.class.getResourceAsStream("/team2485/smartdashboard/extension/res/hot-none.png"));
            leftImage  = ImageIO.read(AxisCameraProcessor2.class.getResourceAsStream("/team2485/smartdashboard/extension/res/hot-left.png"));
            rightImage = ImageIO.read(AxisCameraProcessor2.class.getResourceAsStream("/team2485/smartdashboard/extension/res/hot-right.png"));
            bothImage  = ImageIO.read(AxisCameraProcessor2.class.getResourceAsStream("/team2485/smartdashboard/extension/res/hot-both.png"));
            placeholderImage = ImageIO.read(AxisCameraProcessor2.class.getResourceAsStream("/team2485/smartdashboard/extension/res/axis.png"));
        } catch (IOException e) { }
        ...
        configSaveItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                final AxisCameraConfig config = new AxisCameraConfig(hueMin, hueMax, satMin, satMax, vibMin, vibMax);
    ...
    private void constructConfigMenu() {
        ...
        if (configs.isEmpty()) {
            ...
            Iterator<Map.Entry<String, AxisCameraConfig>> iterator = configs.entrySet().iterator();
            while (iterator.hasNext()) {
                final Map.Entry<String, AxisCameraConfig> next = iterator.next();
                final AxisCameraConfig config = next.getValue();
